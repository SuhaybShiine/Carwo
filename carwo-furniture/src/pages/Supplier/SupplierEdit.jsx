...
function SupplierEdit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const message = error.response?.data?.message || 'Error updating supplier';
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-grid">
                <div className="form-group">
                  ...
                  <input type="text" name="Sup_Name" value={form.Sup_Name} onChange={handleChange} />
                  {errors.Sup_Name && <span className="error">{errors.Sup_Name}</span>}
                </div>

                <div className="form-group">
                  <label>Phone </label>
                  <input type="text" name="Sup_phone" value={form.Sup_phone} onChange={handleChange} />
                  {errors.Sup_phone && <span className="error">{errors.Sup_phone}</span>}
                </div>

                <div className="form-group">
                  <label>Address</label>
                  <input type="text" name="Sup_address" value={form.Sup_address} onChange={handleChange} />
                </div>
              </div>
